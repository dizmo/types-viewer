...
export interface Viewer {
    onRemoteHostAdded: (callback: Function, subscribedCallback?: Function) => UUID;
    onRemoteHostRemoved: (callback: Function, subscribedCallback?: Function) => UUID;
...
export interface Viewer {
    ...
    getDizmoById: <T extends Dizmo>(id: string) => T;
}
export interface Viewer {
    getBundles: <T extends Bundle>() => T[];
    getBundleById: <T extends Bundle>(id: string) => T;
}
export interface Viewer {
    updatePeerList: () => void;
    getRemoteHosts: () => any[];
    getRemoteHostById: (id: string) => any;
    getRemoteHostByIp: (ip: string) => any;
    addRemoteHost: (remoteHostId: string, callback: Function) => void;
}
export interface Viewer {
    ...
    setAudioSettings: (sampleSize: number, sampleRate: number, codec: number) => void;
    recordingIsRunning: () => boolean;
}
export interface Viewer {
    clearSetup: () => void;
    saveSetup: (name: string, id: string, password: string, callback?: Function, padId?: string) => void;
    loadSetup: (id: string, password: string, callback?: Function, options?: {
        clearSpace: boolean;
        loadAsPad: boolean;
        targetPad: string;
    }) => void;
    changeSetupSecret: (id: string, oldPassword: string, newPassword: string, callback?: Function) => void;
}
export interface Viewer {
    onDizmoAdded: (callback: Function, subscribedCallback?: Function) => UUID;
    onDizmoRemoved: (callback: Function, subscribedCallback?: Function) => UUID;
    unsubscribeDizmoChanges: (subscriptionId: UUID) => void;
}
export interface Viewer {
    installBundle: (bundleURI: string, callback: Function) => void;
    installStoreBundle: (bundleId: string, version: string, callback: Function) => void;
}
export interface Viewer {
    onBundleAdded: (callback: Function, subscribedCallback?: Function) => UUID;
    onBundleRemoved: (callback: Function, subscribedCallback?: Function) => UUID;
    unsubscribeBundleChanges: (subscriptionId: UUID) => void;
}
export interface Viewer {
    storeWorkspace: () => void;
    loadWorkspace: () => void;
